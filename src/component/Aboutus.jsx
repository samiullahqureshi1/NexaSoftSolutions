      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-12 pt-[220px] pb-40">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.25fr_1fr] gap-28 items-start">
          ...
          <div className="max-w-[520px] text-[15px] leading-[1.9] text-gray-200 space-y-6">
            <p>
              With <strong className="text-white">10+ years of experience</strong>,{" "}
              <strong className="text-white">500+ prestigious clients</strong>,{" "}
              <strong className="text-white">50+ expert developers</strong>, and a{" "}
              <strong className="text-white">200+ strong team</strong>, Digital Gravity
              stands Dubai’s No.1 digital transformation and marketing agency.
            </p>

            <p>
              We deliver efficient web, mobile, and marketing solutions powered by
              innovative AI and emerging tech like AR, VR, and Blockchain.
            </p>

            <p>
              After marking our footprints in Dubai, we’re now expanding globally across the{" "}
              ...
              — empowering global brands to evolve, scale, and lead in the digital age.
            </p>
          </div>
        </div>
